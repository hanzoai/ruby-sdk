...
class HanzoaiTest < Minitest::Test
  def setup
  ...
  def test_raises_on_unknown_environment
    e = assert_raises(ArgumentError) do
      Hanzoai::Client.new(environment: "wrong")
    end
  ...
  def test_client_default_request_default_retry_attempts
    hanzo = Hanzoai::Client.new(base_url: "http://localhost:4010", api_key: "My API Key")
    requester = MockRequester.new(500, {}, {})
    hanzo.requester = requester

    assert_raises(Hanzoai::InternalServerError) do
      hanzo.get_home
    end
  ...
  def test_client_given_request_default_retry_attempts
    hanzo = Hanzoai::Client.new(base_url: "http://localhost:4010", api_key: "My API Key", max_retries: 3)
    requester = MockRequester.new(500, {}, {})
    hanzo.requester = requester
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Hanzoai::InternalServerError) do
      hanzo.get_home(request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Hanzoai::InternalServerError) do
      hanzo.get_home(request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    hanzo = Hanzoai::Client.new(base_url: "http://localhost:4010", api_key: "My API Key", max_retries: 1)
  ...
  def test_omit_retry_count_header
    ...
    assert_raises(Hanzoai::InternalServerError) do
      hanzo.get_home(request_options: {extra_headers: {"x-stainless-retry-count" => nil}})
    end
  ...
  def test_overwrite_retry_count_header
    ...
    assert_raises(Hanzoai::InternalServerError) do
      hanzo.get_home(request_options: {extra_headers: {"x-stainless-retry-count" => "42"}})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(Hanzoai::APIConnectionError) do
      hanzo.get_home(request_options: {extra_headers: {}})
    end
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    assert_raises(Hanzoai::APIConnectionError) do
      hanzo.get_home(request_options: {extra_headers: {"Authorization" => "Bearer xyz"}})
    end
