...
class HanzoAI::Test::SingletonClient < HanzoAI::Client
  include Singleton
...
class HanzoAI::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @hanzo = HanzoAI::Test::SingletonClient.instance
  end
