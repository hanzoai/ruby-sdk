...
module Hanzoai
          ...
          spec: T.any(
            {
              ...
              enum: T.nilable(T.proc.returns(Hanzoai::Converter::Input)),
              union: T.nilable(T.proc.returns(Hanzoai::Converter::Input))
            },
            T.proc.returns(Hanzoai::Converter::Input),
            Hanzoai::Converter::Input
          )
        )
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Hanzoai::Converter::Input)]]) }
    ...
    sig do
      params(
        key: T.any(Symbol, Hanzoai::Util::AnyHash, T.proc.returns(T.anything), T.anything),
        spec: T.any(Hanzoai::Util::AnyHash, T.proc.returns(T.anything), T.anything)
      )
        .void
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      sig do
        returns(
          T::Hash[Symbol,
                  T.all(
                    Hanzoai::BaseModel::KnownFieldShape,
                    {type_fn: T.proc.returns(Hanzoai::Converter::Input)}
                  )]
        )
      end
      def known_fields
      ...
      sig do
        returns(
          T::Hash[Symbol,
                  T.all(Hanzoai::BaseModel::KnownFieldShape, {type: Hanzoai::Converter::Input})]
        )
      end
      def fields
      end
    ...
    sig { overridable.returns(Hanzoai::Util::AnyHash) }
    def to_h
    end
    ...
    sig { params(keys: T.nilable(T::Array[Symbol])).returns(Hanzoai::Util::AnyHash) }
