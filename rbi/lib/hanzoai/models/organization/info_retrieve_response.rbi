  ...
  module Models
    module Organization
      class InfoRetrieveResponse < Hanzoai::BaseModel
        ...
        sig { returns(T.nilable(Hanzoai::Models::Organization::InfoRetrieveResponse::LlmBudgetTable)) }
        attr_reader :llm_budget_table

        sig do
          params(
            llm_budget_table: T.nilable(
              T.any(Hanzoai::Models::Organization::InfoRetrieveResponse::LlmBudgetTable, Hanzoai::Util::AnyHash)
            )
          )
            .void
        end
        ...
        sig { returns(T.nilable(T::Array[Hanzoai::Models::Organization::InfoRetrieveResponse::Member])) }
        attr_reader :members

        sig do
          params(
            members: T::Array[T.any(Hanzoai::Models::Organization::InfoRetrieveResponse::Member, Hanzoai::Util::AnyHash)]
          )
            .void
        end
        attr_writer :members
        ...
        sig { returns(T.nilable(T::Array[Hanzoai::Models::Organization::InfoRetrieveResponse::Team])) }
        attr_reader :teams

        sig do
          params(
            teams: T::Array[T.any(Hanzoai::Models::Organization::InfoRetrieveResponse::Team, Hanzoai::Util::AnyHash)]
          )
            .void
        end
        attr_writer :teams
            ...
            .returns(
              {
                ...
                members: T::Array[Hanzoai::Models::Organization::InfoRetrieveResponse::Member],
                metadata: T.nilable(T.anything),
                organization_alias: T.nilable(String),
                organization_id: T.nilable(String),
                spend: Float,
                teams: T::Array[Hanzoai::Models::Organization::InfoRetrieveResponse::Team]
              }
            )
        end
        def to_hash
        ...
        class Member < Hanzoai::BaseModel
          ...
          # Represents user-controllable params for a LLM_BudgetTable record
          sig { returns(T.nilable(Hanzoai::Models::Organization::InfoRetrieveResponse::Member::LlmBudgetTable)) }
          attr_reader :llm_budget_table

          sig do
            params(
              llm_budget_table: T.nilable(
                T.any(Hanzoai::Models::Organization::InfoRetrieveResponse::Member::LlmBudgetTable, Hanzoai::Util::AnyHash)
              )
            )
              .void
          end
        ...
        class Team < Hanzoai::BaseModel
          ...
          sig { returns(T.nilable(Hanzoai::Models::Organization::InfoRetrieveResponse::Team::LlmModelTable)) }
          attr_reader :llm_model_table

          sig do
            params(
              llm_model_table: T.nilable(
                T.any(Hanzoai::Models::Organization::InfoRetrieveResponse::Team::LlmModelTable, Hanzoai::Util::AnyHash)
              )
            )
              .void
          end
