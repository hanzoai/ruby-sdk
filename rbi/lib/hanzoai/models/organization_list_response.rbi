...
module Hanzoai
  module Models
    class OrganizationListResponseItem < Hanzoai::BaseModel
      ...
      sig { returns(T.nilable(Hanzoai::Models::OrganizationListResponseItem::LlmBudgetTable)) }
      attr_reader :llm_budget_table

      sig do
        params(
          llm_budget_table: T.nilable(T.any(Hanzoai::Models::OrganizationListResponseItem::LlmBudgetTable, Hanzoai::Util::AnyHash))
        )
          .void
      end
      attr_writer :llm_budget_table

      sig { returns(T.nilable(T::Array[Hanzoai::Models::OrganizationListResponseItem::Member])) }
      attr_reader :members

      sig do
        params(
          members: T::Array[T.any(Hanzoai::Models::OrganizationListResponseItem::Member, Hanzoai::Util::AnyHash)]
        )
          .void
      end
      attr_writer :members
      ...
      sig { returns(T.nilable(T::Array[Hanzoai::Models::OrganizationListResponseItem::Team])) }
      attr_reader :teams

      sig do
        params(
          teams: T::Array[T.any(Hanzoai::Models::OrganizationListResponseItem::Team, Hanzoai::Util::AnyHash)]
        )
          .void
      end
      attr_writer :teams
          ...
          .returns(
            {
              ...
              updated_at: Time,
              updated_by: String,
              llm_budget_table: T.nilable(Hanzoai::Models::OrganizationListResponseItem::LlmBudgetTable),
              members: T::Array[Hanzoai::Models::OrganizationListResponseItem::Member],
              metadata: T.nilable(T.anything),
              organization_alias: T.nilable(String),
              organization_id: T.nilable(String),
              spend: Float,
              teams: T::Array[Hanzoai::Models::OrganizationListResponseItem::Team]
            }
          )
      end
      def to_hash
      ...
      class Member < Hanzoai::BaseModel
        ...
        # Represents user-controllable params for a LLM_BudgetTable record
        sig { returns(T.nilable(Hanzoai::Models::OrganizationListResponseItem::Member::LlmBudgetTable)) }
        attr_reader :llm_budget_table

        sig do
          params(
            llm_budget_table: T.nilable(
              T.any(Hanzoai::Models::OrganizationListResponseItem::Member::LlmBudgetTable, Hanzoai::Util::AnyHash)
            )
          )
            .void
        end
            ...
            .returns(
              {
                ...
                user_id: String,
                budget_id: T.nilable(String),
                llm_budget_table: T.nilable(Hanzoai::Models::OrganizationListResponseItem::Member::LlmBudgetTable),
                spend: Float,
                user: T.anything,
                user_role: T.nilable(String)
              }
      ...
      class Team < Hanzoai::BaseModel
        ...
        sig { returns(T.nilable(Hanzoai::Models::OrganizationListResponseItem::Team::LlmModelTable)) }
        attr_reader :llm_model_table

        sig do
          params(
            llm_model_table: T.nilable(
              T.any(Hanzoai::Models::OrganizationListResponseItem::Team::LlmModelTable, Hanzoai::Util::AnyHash)
            )
          )
            .void
        end
            ...
            .returns(
              {
                ...
                budget_reset_at: T.nilable(Time),
                created_at: T.nilable(Time),
                llm_model_table: T.nilable(Hanzoai::Models::OrganizationListResponseItem::Team::LlmModelTable),
                max_budget: T.nilable(Float),
                max_parallel_requests: T.nilable(Integer),
                members: T::Array[T.anything],
    ...
    OrganizationListResponse =
      T.let(Hanzoai::ArrayOf[Hanzoai::Models::OrganizationListResponseItem], Hanzoai::Converter)
  end
end
