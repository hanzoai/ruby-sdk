...
module Hanzoai
  ...
  module Util
    ...
    #   structure when using `Hanzoai::Util.deep_merge`.
    #
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(Hanzoai::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(Hanzoai::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: Hanzoai::Util::ParsedUriShape).returns(URI::Generic) }
      def unparse_uri(parsed)
      end

      # @api private
      sig do
        params(lhs: Hanzoai::Util::ParsedUriShape, rhs: Hanzoai::Util::ParsedUriShape).returns(URI::Generic)
      end
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(Hanzoai::Util::ServerSentEvent) }
