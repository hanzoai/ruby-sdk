...
module HanzoAI
  ...
  class BaseClient
      ...
      T.type_alias do
        {
          ...
          page: T.nilable(T::Class[HanzoAI::BasePage[HanzoAI::BaseModel]]),
          stream: T.nilable(T::Class[T.anything]),
          model: T.nilable(HanzoAI::Converter::Input),
          options: T.nilable(T.any(HanzoAI::RequestOptions, HanzoAI::Util::AnyHash))
        }
      end
    ...
    class << self
      # @api private
      sig { params(req: HanzoAI::BaseClient::RequestComponentsShape).void }
      def validate!(req)
      end
      ...
      sig do
        params(
          request: HanzoAI::BaseClient::RequestInputShape,
          status: Integer,
          response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
        )
          .returns(HanzoAI::BaseClient::RequestInputShape)
      end
      ...
      sig do
        params(
          status: T.any(Integer, HanzoAI::APIConnectionError),
    ...
    sig do
      overridable
        .params(req: HanzoAI::BaseClient::RequestComponentsShape, opts: HanzoAI::Util::AnyHash)
        .returns(HanzoAI::BaseClient::RequestInputShape)
    end
