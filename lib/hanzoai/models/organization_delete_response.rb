...
module Hanzoai
  module Models
    class OrganizationDeleteResponseItem < Hanzoai::BaseModel
      ...
      #
      #   @return [Hanzoai::Models::OrganizationDeleteResponseItem::LlmBudgetTable, nil]
      optional :llm_budget_table,
               -> { Hanzoai::Models::OrganizationDeleteResponseItem::LlmBudgetTable },
               nil?: true

      # @!attribute [r] members
      #
      #   @return [Array<Hanzoai::Models::OrganizationDeleteResponseItem::Member>, nil]
      optional :members, -> { Hanzoai::ArrayOf[Hanzoai::Models::OrganizationDeleteResponseItem::Member] }

      # @!parse
      #   # @return [Array<Hanzoai::Models::OrganizationDeleteResponseItem::Member>]
      #   attr_writer :members
      ...
      # @!attribute [r] teams
      #
      #   @return [Array<Hanzoai::Models::OrganizationDeleteResponseItem::Team>, nil]
      optional :teams, -> { Hanzoai::ArrayOf[Hanzoai::Models::OrganizationDeleteResponseItem::Team] }

      # @!parse
      #   # @return [Array<Hanzoai::Models::OrganizationDeleteResponseItem::Team>]
      #   attr_writer :teams
      ...
      #   # @param llm_budget_table [Hanzoai::Models::OrganizationDeleteResponseItem::LlmBudgetTable, nil]
      #   # @param members [Array<Hanzoai::Models::OrganizationDeleteResponseItem::Member>]
      #   # @param metadata [Object, nil]
      #   # @param organization_alias [String, nil]
      #   # @param organization_id [String, nil]
      #   # @param spend [Float]
      #   # @param teams [Array<Hanzoai::Models::OrganizationDeleteResponseItem::Team>]
      #   #
      #   def initialize(
      #     budget_id:,
      #     created_at:,
      ...
      class Member < Hanzoai::BaseModel
        ...
        #   Represents user-controllable params for a LLM_BudgetTable record
        #
        #   @return [Hanzoai::Models::OrganizationDeleteResponseItem::Member::LlmBudgetTable, nil]
        optional :llm_budget_table,
                 -> { Hanzoai::Models::OrganizationDeleteResponseItem::Member::LlmBudgetTable },
                 nil?: true
        ...
        #   # @param llm_budget_table [Hanzoai::Models::OrganizationDeleteResponseItem::Member::LlmBudgetTable, nil]
        #   # @param spend [Float]
        #   # @param user [Object]
      ...
      class Team < Hanzoai::BaseModel
        ...
        #
        #   @return [Hanzoai::Models::OrganizationDeleteResponseItem::Team::LlmModelTable, nil]
        ...
        #   # @param llm_model_table [Hanzoai::Models::OrganizationDeleteResponseItem::Team::LlmModelTable, nil]
        #   # @param max_budget [Float, nil]
        #   # @param max_parallel_requests [Integer, nil]
        ...
        class LlmModelTable < Hanzoai::BaseModel
          ...
          optional :model_aliases,
                   union: -> { Hanzoai::Models::OrganizationDeleteResponseItem::Team::LlmModelTable::ModelAliases },
                   nil?: true
    ...
    OrganizationDeleteResponse = Hanzoai::ArrayOf[-> { Hanzoai::Models::OrganizationDeleteResponseItem }]
  end
end
