...
module Hanzoai
  module Models
    class CustomerRetrieveInfoResponse < Hanzoai::BaseModel
      ...
      #
      #   @return [Symbol, Hanzoai::Models::CustomerRetrieveInfoResponse::AllowedModelRegion, nil]
      optional :allowed_model_region,
               enum: -> { Hanzoai::Models::CustomerRetrieveInfoResponse::AllowedModelRegion },
               nil?: true
      ...
      #
      #   @return [Hanzoai::Models::CustomerRetrieveInfoResponse::LlmBudgetTable, nil]
      optional :llm_budget_table,
               -> { Hanzoai::Models::CustomerRetrieveInfoResponse::LlmBudgetTable },
               nil?: true
      ...
      #   # @param allowed_model_region [Symbol, Hanzoai::Models::CustomerRetrieveInfoResponse::AllowedModelRegion, nil]
      #   # @param default_model [String, nil]
      #   # @param llm_budget_table [Hanzoai::Models::CustomerRetrieveInfoResponse::LlmBudgetTable, nil]
      #   # @param spend [Float]
      #   #
      #   def initialize(
      #     blocked:,
