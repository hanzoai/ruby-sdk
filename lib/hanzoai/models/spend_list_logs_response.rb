...
module Hanzoai
  module Models
    class SpendListLogsResponseItem < Hanzoai::BaseModel
      ...
      required :end_time,
               union: -> { Hanzoai::Models::SpendListLogsResponseItem::EndTime },
               api_name: :endTime,
               nil?: true
      ...
      required :messages, union: -> { Hanzoai::Models::SpendListLogsResponseItem::Messages }, nil?: true
      ...
      #
      #   @return [String, Array<Object>, Object, nil]
      required :response, union: -> { Hanzoai::Models::SpendListLogsResponseItem::Response }, nil?: true

      # @!attribute start_time
      #
      #   @return [String, Time, nil]
      required :start_time,
               union: -> { Hanzoai::Models::SpendListLogsResponseItem::StartTime },
               api_name: :startTime,
               nil?: true
      ...
      module Messages
        ...
        variant Hanzoai::Models::SpendListLogsResponseItem::Messages::UnionMember1Array
      ...
      module Response
        ...
        variant Hanzoai::Models::SpendListLogsResponseItem::Response::UnionMember1Array
    ...
    SpendListLogsResponse = Hanzoai::ArrayOf[-> { Hanzoai::Models::SpendListLogsResponseItem }]
  end
end
