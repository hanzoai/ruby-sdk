...
module HanzoAI
  module Models
    class OrganizationListResponseItem < HanzoAI::BaseModel
      # @!attribute budget_id
      #
      #   @return [String]
      ...
      #
      #   @return [HanzoAI::Models::OrganizationListResponseItem::LlmBudgetTable, nil]
      optional :llm_budget_table,
               -> { HanzoAI::Models::OrganizationListResponseItem::LlmBudgetTable },
               nil?: true

      # @!attribute [r] members
      #
      #   @return [Array<HanzoAI::Models::OrganizationListResponseItem::Member>, nil]
      optional :members, -> { HanzoAI::ArrayOf[HanzoAI::Models::OrganizationListResponseItem::Member] }

      # @!parse
      #   # @return [Array<HanzoAI::Models::OrganizationListResponseItem::Member>]
      #   attr_writer :members
      ...
      # @!attribute [r] teams
      #
      #   @return [Array<HanzoAI::Models::OrganizationListResponseItem::Team>, nil]
      optional :teams, -> { HanzoAI::ArrayOf[HanzoAI::Models::OrganizationListResponseItem::Team] }

      # @!parse
      #   # @return [Array<HanzoAI::Models::OrganizationListResponseItem::Team>]
      #   attr_writer :teams
      ...
      #   # @param llm_budget_table [HanzoAI::Models::OrganizationListResponseItem::LlmBudgetTable, nil]
      #   # @param members [Array<HanzoAI::Models::OrganizationListResponseItem::Member>]
      #   # @param metadata [Object, nil]
      #   # @param organization_alias [String, nil]
      #   # @param organization_id [String, nil]
      #   # @param spend [Float]
      #   # @param teams [Array<HanzoAI::Models::OrganizationListResponseItem::Team>]
      #   #
      #   def initialize(
      #     budget_id:,
      #     created_at:,
      ...
      class Member < HanzoAI::BaseModel
        ...
        #   Represents user-controllable params for a LLM_BudgetTable record
        #
        #   @return [HanzoAI::Models::OrganizationListResponseItem::Member::LlmBudgetTable, nil]
        optional :llm_budget_table,
                 -> { HanzoAI::Models::OrganizationListResponseItem::Member::LlmBudgetTable },
                 nil?: true
        ...
        #   # @param llm_budget_table [HanzoAI::Models::OrganizationListResponseItem::Member::LlmBudgetTable, nil]
        #   # @param spend [Float]
        #   # @param user [Object]
      ...
      class Team < HanzoAI::BaseModel
        ...
        #
        #   @return [HanzoAI::Models::OrganizationListResponseItem::Team::LlmModelTable, nil]
        optional :llm_model_table,
                 -> { HanzoAI::Models::OrganizationListResponseItem::Team::LlmModelTable },
                 nil?: true
        ...
        #   # @param llm_model_table [HanzoAI::Models::OrganizationListResponseItem::Team::LlmModelTable, nil]
        #   # @param max_budget [Float, nil]
        #   # @param max_parallel_requests [Integer, nil]
        ...
        class LlmModelTable < HanzoAI::BaseModel
          ...
          optional :model_aliases,
                   union: -> { HanzoAI::Models::OrganizationListResponseItem::Team::LlmModelTable::ModelAliases },
                   nil?: true
    ...
    OrganizationListResponse = HanzoAI::ArrayOf[-> { HanzoAI::Models::OrganizationListResponseItem }]
  end
end
