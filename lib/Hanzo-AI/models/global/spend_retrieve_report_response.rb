  ...
  module Models
    module Global
      class SpendRetrieveReportResponseItem < HanzoAI::BaseModel
        ...
        required :end_time,
                 union: -> { HanzoAI::Models::Global::SpendRetrieveReportResponseItem::EndTime },
                 api_name: :endTime,
                 nil?: true
        ...
        required :messages,
                 union: -> { HanzoAI::Models::Global::SpendRetrieveReportResponseItem::Messages },
                 nil?: true
        ...
        #   @return [String, Array<Object>, Object, nil]
        required :response,
                 union: -> { HanzoAI::Models::Global::SpendRetrieveReportResponseItem::Response },
                 nil?: true
        ...
        #   @return [String, Time, nil]
        required :start_time,
                 union: -> { HanzoAI::Models::Global::SpendRetrieveReportResponseItem::StartTime },
                 api_name: :startTime,
                 nil?: true
      ...
      SpendRetrieveReportResponse =
        HanzoAI::ArrayOf[-> { HanzoAI::Models::Global::SpendRetrieveReportResponseItem }]
    end
  end
end
