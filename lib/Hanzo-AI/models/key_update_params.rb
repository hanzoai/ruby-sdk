...
module HanzoAI
  module Models
    class KeyUpdateParams < HanzoAI::BaseModel
      ...
      # @!attribute temp_budget_expiry
      #
      #   @return [Time, nil]
      optional :temp_budget_expiry, Time, nil?: true

      # @!attribute temp_budget_increase
      #
      #   @return [Float, nil]
      optional :temp_budget_increase, Float, nil?: true
      ...
      #   # @param temp_budget_expiry [Time, nil]
