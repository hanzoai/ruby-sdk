...
module HanzoAI
  module Models
    class SpendListTagsResponseItem < HanzoAI::BaseModel
      ...
      required :end_time,
               union: -> { HanzoAI::Models::SpendListTagsResponseItem::EndTime },
               api_name: :endTime,
               nil?: true
      ...
      required :messages, union: -> { HanzoAI::Models::SpendListTagsResponseItem::Messages }, nil?: true
      ...
      #
      #   @return [String, Array<Object>, Object, nil]
      required :response, union: -> { HanzoAI::Models::SpendListTagsResponseItem::Response }, nil?: true

      # @!attribute start_time
      #
      #   @return [String, Time, nil]
      required :start_time,
               union: -> { HanzoAI::Models::SpendListTagsResponseItem::StartTime },
               api_name: :startTime,
               nil?: true
      ...
      module Messages
        ...
        variant HanzoAI::Models::SpendListTagsResponseItem::Messages::UnionMember1Array
      ...
      module Response
        ...
        variant HanzoAI::Models::SpendListTagsResponseItem::Response::UnionMember1Array
    ...
    SpendListTagsResponse = HanzoAI::ArrayOf[-> { HanzoAI::Models::SpendListTagsResponseItem }]
  end
end
