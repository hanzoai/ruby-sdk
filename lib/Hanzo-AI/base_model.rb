...
module HanzoAI
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in HanzoAI::Converter | Module | Symbol
          -> { spec }
        in true | false
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(HanzoAI::Enum) && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def variant(key, spec = nil)
      variant_info =
        ...
        in Proc | HanzoAI::Converter | Module | Hash
    ...
    private def resolve_variant(value)
      ...
      in [Symbol, Hash]
        ...
        resolved.nil? ? HanzoAI::Unknown : resolved.call
      else
        nil
      end
    end
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(HanzoAI::Union) && other.derefed_variants == derefed_variants
    end
    ...
    def coerce(value)
      if (variant = resolve_variant(value))
        return HanzoAI::Converter.coerce(variant, value)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        case HanzoAI::Converter.try_strict_coerce(variant, value)
        in [true, coerced, _]
          return coerced
        in [false, true, score]
      ...
      variant.nil? ? value : HanzoAI::Converter.coerce(variant, value)
    end
    ...
    def dump(value)
      if (variant = resolve_variant(value))
        return HanzoAI::Converter.dump(variant, value)
      end
  ...
  class ArrayOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(HanzoAI::ArrayOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { HanzoAI::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { HanzoAI::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case HanzoAI::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class HashOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(HanzoAI::HashOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = HanzoAI::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          HanzoAI::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case HanzoAI::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    class << self
      ...
      def reverse_map
        @reverse_map ||= (self < HanzoAI::BaseModel ? superclass.reverse_map.dup : {})
      end
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Module | HanzoAI::Converter
        ...
        define_method(name_sym) do
          ...
          HanzoAI::Converter.coerce(field_type, value)
        rescue StandardError
          name = self.class.name.split("::").last
          raise HanzoAI::ConversionError.new(
    ...
    class << self
      ...
      def coerce(value)
        case HanzoAI::Util.coerce_hash(value)
        in Hash => coerced
          new(coerced)
        else
          value
        ...
        values = coerced.filter_map do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              [api_name, HanzoAI::Converter.dump(target, val)]
            end
          end
        end.to_h
      ...
      def try_strict_coerce(value)
        ...
        known_fields.each_value do |field|
          ...
          in [_, true]
            ...
            case HanzoAI::Converter.try_strict_coerce(target, item)
            in [true, coerced, score]
              tally += score
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Module, Hash] if type <= HanzoAI::BaseModel
              type.new(value)
            in [HanzoAI::ArrayOf, Array] | [HanzoAI::HashOf, Hash]
              type.coerce(value)
            else
              value
            end
